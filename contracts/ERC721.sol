...
contract ERC721 is IERC721 {
    ...
    modifier isApprovedForTransfer(address _spender, uint256 _tokenId) {
        require(
            ownerOf(_tokenId) == _spender ||
            getApproved(_tokenId) == _spender ||
            isApprovedForAll(_tokenOwner[_tokenId], _spender),
            "_spender is not approved for transfer"
            );
        _;
    }
    ...
    view
    override
    isNonZeroAddress(_tokenOwner[_tokenId])
    returns (address)
    {
    ...
    override
    {
        ...
        require(
            ...
            isApprovedForAll(_tokenOwner[_tokenId], msg.sender)
            );
    ...
    function _transferFromContract(address _to, uint256 _tokenId)
    internal
    isNonZeroAddress(_to)
    tokenExists(_tokenId)
    {
